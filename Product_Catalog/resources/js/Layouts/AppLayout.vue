...
import Side from '@/Pages/admin/Sidebar.vue';
defineProps({
    title: String,
});
                ...
                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures" align="right" width="60">
                  ...
                  <template #content>
                    <div class="w-60">
                      ...
                      <DropdownLink :href="route('teams.show', $page.props.auth.user.current_team.id)">Team Settings</DropdownLink>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
          ...
          <div class="mt-3 space-y-1">
            ...
            <template v-if="$page.props.jetstream.hasTeamFeatures">
              <div class="border-t border-gray-200"></div>
              <div class="block px-4 py-2 text-xs text-gray-400">Manage Team</div>
              <ResponsiveNavLink :href="route('teams.show', $page.props.auth.user.current_team.id)" :active="route().current('teams.show')">Team Settings</ResponsiveNavLink>
